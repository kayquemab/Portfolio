      ...
      <div className="grid gap-4 md:grid-cols-3">
        {certificacoesPlanejadas.map((certificacao, index) => (
          <motion.a
            ...
            className="group flex flex-col rounded-2xl border border-white/[0.08] bg-white/[0.02] p-5 text-left transition-colors hover:border-white/15 hover:bg-white/[0.04]"
